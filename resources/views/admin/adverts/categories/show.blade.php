...
@section('content')
    ...
    <p><a href="{{ route('categories.attributes.create', $category) }}" class="btn btn-success">Add Attribute</a></p>
    ...
    <table class="table table-bordered">
        ...
        @forelse ($attributes as $attribute)
            <tr>
                <td>{{ $attribute->sort }}</td>
                <td>
                    <a href="{{ route('categories.attributes.show', [$category, $attribute]) }}">{{ $attribute->name }}</a>
                </td>
                <td>{{ $attribute->type }}</td>
                <td>{{ $attribute->required ? 'Yes' : '' }}</td>
            </tr>
